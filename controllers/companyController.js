...
exports.createCompany = async (req, res) => {
  ...
  try {
    ...
    const { contactId, companyName, url, companyDescription, comments } = req.body
    ...
    // if the user selected a contact, add the id to the company object
    if (contactId) {
    ...
    // Console log the company object
    console.log("Saved new company to db: ", company)
